...
SCENES = {
    ...
    "ico_tips":    "一个航海用的黄铜罗盘",
    "ico_fix":     "一支笔在纸上打勾修改",
    "ico_vocab":   "一摞小卡片，最上面一张翻开着",
    "day_start": "晴天的海面上一个人划着小木船出发，远处是一座亮黄色的灯塔，天上飘着蓬松的白云，海鸥在飞",
    # ── 夜航版的五座岛：深色主题下用，构图跟日航一一对应 ──
    "night_yanyu": "夜色的海上一座小岛，岛上一个人坐在一摞书上就着暖黄的灯读书",
    "night_shuliang": "夜色的海上一座小岛，岛上立着一把木质大算盘，算珠在暖黄灯下发亮",
    "night_panduan": "夜色的海上一座小岛，岛上悬浮着一组排成阵列的几何图形，一个人举着灯看它们",
    "night_ziliao": "夜色的海上一座小岛，岛上是由高低柱状图组成的山峰，一个人站在最高处提着灯",
    "night_changshi": "夜色的海上一座小岛，岛上一个人靠着一个大地球仪，就着暖黄的灯看书",
